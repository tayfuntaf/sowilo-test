...
export default function Demos() {
  ...
  const Info = () => {
    return (
      <Section className="h-screen overflow-hidden relative">
        <div className="absolute w-full h-full scale-100 bg-auto">
                    ...
                    <div>
                      <Fade cascade direction="up" triggerOnce>
                        <Heading className="mb-10">
                          <h1 className="text-[#f5f5f5] font-thin font-2 mb-10 tracking-widest ">
                            {t("Sowilo")}
                            <br />
                            {/* <Image
                              src={logoo}
                          ...
                          <p className="text-[#f5f5f5] text-2xl tracking-widest">
                            {/* {t(
                              "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo."
                            )} */}
                            Güzelliğe açılan kapınız
                          </p>
                        </Heading>
                        <Button
                          custom={true ? 1 : 0}
                        ...
                        >
                          <a
                            href={`https://wa.me/+905161664323?text=${encodeURIComponent(
                              `  Merhaba   `
                            )}`}
                            target="_blank"
                          >
                            {t("Randevu Almak İçin Bizimle İletişime Geçin")}
                          </a>
                        </Button>
                      </Fade>
                    </div>
              ...
              <Row size="md">
                {services.map((service, serviceIndex) => (
                  <Col md={12} lg={4} key={`services-item-${serviceIndex}`}>
                    <InfoBox
                      custom={true ? 1 : 0}
                      className="pt-20 px-12 pb-12 bg-gradient-to-t from-pink-200"
                      color="primary"
                      //   icon={service.icon}
  ...
  const Portfolios = (props) => {
    ...
    return (
      <Section className="overflow-hidden pt-16 pb-16 bg-gradient-to-r via-transparent from-pink-50">
        <Container>
            ...
            <Row className="relative align-items-end">
              <Col lg={6}>
                ...
                <Fade cascade triggerOnce>
                  <Heading className="max-w-md mb-10  lg:mb-0 lg:pr-8">
                    <h2 className="font-1 font-semibold mb-4 text-2xl">
              ...
              <Row className="relative align-items-end justify-between">
                <Col lg={6}>
                  <Heading className="max-w-md">
                    <h2 className="text-4xl lg:text-4xl font-1 font-bold">
                      {t("Bakım Önerileri")}
                    </h2>
                  </Heading>
                </Col>
